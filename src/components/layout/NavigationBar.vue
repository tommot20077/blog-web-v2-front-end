...
<template>
  ...
  <nav class="fixed top-5 left-0 right-0 z-50 flex justify-center px-10 pointer-events-none">
    ...
    >
      <router-link to="/" class="font-medium text-[16px] hover:opacity-70 transition-opacity">首頁</router-link>
      <router-link to="/articles" class="font-medium text-[16px] hover:opacity-70 transition-opacity">文章</router-link>
      <!-- Logo 區塊 -->
      ...
      <span class="font-medium text-[16px]">你好,TOM!</span>
      <a href="#" class="font-medium text-[16px] pl-4 border-l border-[var(--text-main)]/30 hover:opacity-70 transition-opacity">登入 / 註冊</a>
    </div>
