...
<template>
  ...
  <nav class="fixed top-5 left-0 right-0 z-50 flex justify-center px-10 pointer-events-none">
    ...
    >
      ...
      <span class="font-medium text-[16px] hidden md:inline">你好,TOM!</span>
      <a href="#" class="font-medium text-[16px] pl-4 border-l border-[var(--text-main)]/30 hover:opacity-70 transition-opacity hidden md:inline">登入 / 註冊</a>
    </div>
