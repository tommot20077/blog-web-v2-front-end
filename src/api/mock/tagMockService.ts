...
const mockTagDetails: TagDetail[] = [
  { uuid: 'tag-1', name: 'Vue', slug: 'vue', color: '#42b883', icon: 'vue-icon', description: 'Vue.js 前端框架', usageCount: 18 },
  { uuid: 'tag-2', name: 'React', slug: 'react', color: '#61dafb', icon: 'react-icon', description: 'React 前端框架', usageCount: 12 },
  { uuid: 'tag-3', name: 'TypeScript', slug: 'typescript', color: '#3178c6', icon: 'ts-icon', description: 'TypeScript 程式語言', usageCount: 15 },
  { uuid: 'tag-4', name: 'Tailwind CSS', slug: 'tailwind-css', color: '#38bdf8', icon: 'tailwind-icon', description: 'Utility-first CSS 框架', usageCount: 9 },
  { uuid: 'tag-5', name: 'Node.js', slug: 'nodejs', color: '#339933', icon: 'node-icon', description: 'Node.js 後端執行環境', usageCount: 11 },
];
