...
export function createTestRouter(initialRoute = '/') {
  const router = createRouter({
    ...
    routes: [
      ...
      { path: '/bookmarks', name: 'bookmarks', component: StubComponent },
      { path: '/admin', name: 'admin-dashboard', component: StubComponent },
      { path: '/admin/review', name: 'admin-review', component: StubComponent },
      { path: '/admin/categories', name: 'admin-categories', component: StubComponent },
      { path: '/admin/tags', name: 'admin-tags', component: StubComponent },
      { path: '/admin/search', name: 'admin-search', component: StubComponent },
      { path: '/settings', name: 'settings', component: StubComponent },
      { path: '/tags/:slug', name: 'tag', component: StubComponent, props: true },
      { path: '/author/:handle', name: 'author', component: StubComponent, props: true },
